...
Retrieve Card ids from the -previously downloaded, "constants" card .cs file
"""
...
cs_file_path = os.path.join(current_directory, "constants", "VanillaCardIDs.cs")
json_file_path = os.path.join(current_directory, "card_ids.json")
...
with open(json_file_path, "w") as json_file:
    json.dump(card_ids, json_file, indent=4)
