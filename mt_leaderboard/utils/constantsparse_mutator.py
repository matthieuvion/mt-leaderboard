...
Retrieve mutator ids from the -previously downloaded, "constants" mutator .cs file
"""
...
cs_file_path = os.path.join(current_directory, "constants", "VanillaMutatorIDs.cs")
json_file_path = os.path.join(current_directory, "mutator_ids.json")
...
with open(json_file_path, "w") as json_file:
    json.dump(mutator_ids, json_file, indent=4)
