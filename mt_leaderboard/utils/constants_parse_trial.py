...
trial ids from the -previously downloaded, "constants" trial .cs file
"""
...
cs_file_path = os.path.join(current_directory, "constants", "VanillaTrialIDs.cs")
json_file_path = os.path.join(current_directory, "trial_ids.json")
...
with open(json_file_path, "w") as json_file:
    json.dump(trial_ids, json_file, indent=4)
