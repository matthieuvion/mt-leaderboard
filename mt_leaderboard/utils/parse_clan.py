...
Retrieve clan ids from the -previously downloaded, "constants" clan .cs file
"""
...
cs_file_path = os.path.join(current_directory, "constants", "VanillaClanIDs.cs")
json_file_path = os.path.join(current_directory, "clan_ids.json")
...
pattern_id = re.compile(r'public const string (\w+) = "(.*?)";')
...
with open(json_file_path, "w") as json_file:
    json.dump(clan_ids, json_file, indent=4)
