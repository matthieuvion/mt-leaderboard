"""
Convenience script(s) to parse
collectable relic ids from the -previously downloaded, "constants" collectable relic .cs file
"""
...
cs_file_path = os.path.join(
    current_directory, "constants", "VanillaCollectableRelicIDs.cs"
)
json_file_path = os.path.join(current_directory, "collectable_relic_ids.json")
...
for i, line in enumerate(lines):
    ...
    if match_id:
        ...
        collectable_relic_ids[id_value] = {
            "from_file": "VanillaCollectableRelicIDs",
...
with open(json_file_path, "w") as json_file:
    json.dump(collectable_relic_ids, json_file, indent=4)
