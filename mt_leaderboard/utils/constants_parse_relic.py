...
relic ids from the -previously downloaded, "constants" relic .cs file
"""
...
cs_file_path = os.path.join(current_directory, "constants", "VanillaRelicIDs.cs")
json_file_path = os.path.join(current_directory, "relic_ids.json")
...
with open(json_file_path, "w") as json_file:
    json.dump(relic_ids, json_file, indent=4)
